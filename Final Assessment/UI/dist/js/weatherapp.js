...
var WeatherFirst=React.createClass({displayName: "WeatherFirst",
  ...
  handleReport:function(d){
    ...
    return(React.createElement("div", null, 
          ...
          //  console.log(data);
            ...
            return(
            React.createElement("div", {className: "well row", key: count++}, 
              React.createElement("div", {className: "col-lg-4"}, 
                  React.createElement("li", {className: "listitems"}, React.createElement("h2", null, data.name)), 
                  React.createElement("li", {className: "listitems"}, React.createElement("button", {className: "btn btn-info ", onClick: (event)=>{self.handleReport(data)}}, "refresh"), "                ")
                ), 
                React.createElement("div", {className: "col-lg-8", id: "view"}, 

                React.createElement("h3", null, "Temparature:    ", data.main.temp), 
                React.createElement("h3", null, "Pressure:    ", data.main.pressure), 
                React.createElement("h3", null, "Humidity:    ", data.main.humidity)
...
module.exports = (
  ...
  React.createElement(Route, null, 
        ...
        React.createElement(DefaultRoute, {handler: report, name: "HomePage"})
        )
  )

);

},{"./components/WeatherFirst":200,"./pages/Master/Master":201,"react":199,"react-router":35}],203:[function(require,module,exports){
var React = require('react');
var Router = require('react-router');
...
Router.run(routes, Router.HistoryLocation, function(Root){
  React.render(React.createElement(Root, null),  document.getElementById('weatherreport'));
});
},{"./routes.js":202,"react":199,"react-dom":10,"react-router":35}]},{},[203]);
